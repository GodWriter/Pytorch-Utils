# Reference Blog: https://www.cnblogs.com/zmshy2128/p/6128663.html
...
def stretchImage2(data, vv=10.0):
    ''' 非线性拉伸 '''
...
def ProcessHdr(m, r, eps, ratio, para1):
    ''' 单尺度处理 '''
...
def ProcessHdrMs(m, r=[161], eps=[0.005,0.001, 0.01], ratio=[0.98, 0.98, 0.92], para1=10.0):
    ''' 多尺度处理 '''
...
if __name__ == '__main__':                             
    ...
    cv2.imwrite("data/output/retinex.jpg", m2)
